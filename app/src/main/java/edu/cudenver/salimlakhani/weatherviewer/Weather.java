...
public class Weather {
    ...
    public Weather (String weather) {
        ...
        try {
            ...
            /* The above statement will extract the following object.
             {
     *     "temp": 281.52,
     *     "feels_like": 278.99,
     *     "temp_min": 280.15,
     ...
     *   }
            ...
            /* The above statement will extract the following array
            [
     *     {
     *       "id": 800,
     *       "main": "Clear",
     ...
     *   ]
            ...
            /* The above statement will extract item at index position 0 in the WeatherList array
            It will get the following object
            {
     *       "id": 800,
     *       "main": "Clear",
     *       "description": "clear sky",
